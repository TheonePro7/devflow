...
**Claude Code 开发工作流 skill — 7 阶段（Phase 0-6）整合 TDD、git worktrees、子代理开发与代码审核**

7-phase standard development workflow for Claude Code, orchestrating TDD, git worktrees, subagent-driven development, code review, and the obra/superpowers skill system.
